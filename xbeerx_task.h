...
float tCollideAcc(float dist, int bear, float myV, int myA_y, int myA_x, int myHead, float oV, int oA_y, int oA_x, int oHead);
float tCollide(float dist, float bear, float myV, float myHead, float oV, float oHead);
