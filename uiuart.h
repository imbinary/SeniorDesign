...
//
//*****************************************************************************
extern void uiUARTxConfig(uint32_t ui32Port, uint32_t ui32Baud,
                            uint32_t ui32SrcClock);
extern int uiUARTgets(char *pcBuf, uint32_t ui32Len);
extern unsigned char uiUARTgetc(void);
extern void uiUARTprintf(const char *pcString, ...);
extern void uiUARTvprintf(const char *pcString, va_list vaArgP);
extern int uiUARTwrite(const char *pcBuf, uint32_t ui32Len);
#ifdef UART_BUFFERED
extern int uiUARTPeek(unsigned char ucChar);
extern void uiUARTFlushTx(bool bDiscard);
